...
int main()
{
  	int r1, c1, r2, c2, i, j, k, sum = 0, identity = 1, opt, isIdentity;
	  ...
	  switch(opt)
	  {
		case 1:	  
			  ...
			  if(!(r1 > 0) || !(c1 > 0) || !(r2 > 0) || !(c2 > 0))
			  	break;
			  if ( c1 != r2 )  // matrices can not be multiplied
			  {
			  	system("cls");
			  ...
			  else // matrices can be multiplied
			  {
			    ...
			    for ( i = 0 ; i < r1 ; i++ ) // to iterate the rows of first matrix
			    {
			      for ( j = 0 ; j < c2 ; j++ ) // to iterate the columns of second matrix
			      {
			        for ( k = 0 ; k < r2 ; k++ ) // to iterate the rows of second matrix
			        {
    ...
    if(isIdentity == 1)
    {
        printf("\nFirst matrix is an Identity Matrix.\n");

        
    }
    else
    {
        printf("First matrix is not Identity Matrix");
    }
    ...
    if(isIdentity == 1)
    {
        printf("\nSecond matrix is an Identity Matrix.\n");

        
    }
    else
    {
        printf("Second matrix is not Identity Matrix");
    }
